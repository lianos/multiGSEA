...
# Calling GSEA methods ouside of `multiGSEA`
...
Here we show how to do this enrichment for genes upregaulted in tumors vs.
...
pdbc <- conform(pdb, lfc$featureId)
hg.res <- hyperGeometricTest(pdbc, selected, lfc$featureId)
```

These are the pathways with an FDR <= 0.1:
