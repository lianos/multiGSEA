...
Full details about using this software package is provided in the included
vignette, however a brief description is outlined below.
...
rasteriaed versions are save for use with this `README.md` file:
