...
analysis above by verifying that the t-statistics generated by both approaches
are identical.
...
Note that the results provided in the table generated from a call to `geneSet`
are independant of GSEA method.
