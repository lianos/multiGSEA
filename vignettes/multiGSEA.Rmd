...
we choose not to "unenter" and "unscale" them:
...
mgheatmap(gdb.2, vm.bh, col=hcols, aggregate.by="none", split=TRUE,
...
```{r gshm2}
mgheatmap(gdb.2, vm.bh, col=hcols, aggregate.by="ewm", split=FALSE,
...
```{r gshm-all}
mgheatmap(gdb.sub, vm.bh, col=hcols,
...
The multiGSEA pacakge strives to include the latest version of the MSigDB gene
set collections within the application itself.
...
value of the `species` argument in your `getMSigGeneSetDb` call.
