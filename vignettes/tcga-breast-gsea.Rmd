...
You might be curious what the distribution of log fold chnages are for the
...
`MultiGSEAResult` into a browsable widget for an rmarkdown document. It provides
several parameters tha can be used to customize which (and how many) results
are shown.
