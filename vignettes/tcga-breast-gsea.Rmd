...
Let's see how these two voom'd vs edgeR results compare, and let's add
`romer` to the mix, too!
...
## DEBUG: why do the bacground densities look different between these results
## and the limma/voom ones?
